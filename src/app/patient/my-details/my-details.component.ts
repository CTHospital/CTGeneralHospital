...
export class MyDetailsComponent implements OnInit {
  ...
  submitted = false;
  ngOnInit(): void {
    this.patientDetailsFromLogin = JSON.parse(
    ...
    this.patientData = d;
    this.patientService
      .getPatientDetailsById(this.patientDetailsFromLogin.patientId)
      .subscribe((d) => {
        this.patientData = d;
  ...
  submitAllergy() {
    ...
    this.patientService
      .addAllergy(this.patientDetailsFromLogin.patientId, this.allergyArrays)
      .subscribe();
    this.block1 = false;
    this.block2 = true;
  ...
  updateDetails() {
    ...
    this.patientService
      .updatePatientById(
        this.form.value,
        this.patientDetailsFromLogin.patientId
      )
      .subscribe();
